...
5. Tipo de aplicacion: **"Aplicacion de escritorio"**
   - Nombre: `kobo-umap-script`
   - Click en **"Crear"**

6. Click en **"Descargar JSON"**

7. Renombrar el archivo descargado a exactamente: `credentials.json`

8. Copiar ese archivo a la misma carpeta donde esta `kobo_a_umap.py`
